...
:: LCMDLauncher версия 1.13 от lelik_01
:: Библиотеки для запуска Minecraft можно взять отсюда: https://github.com/lelik01/LCMDlauncher/releases

:: Путь к Java
set JAVA="C:\Program Files\Java\jre1.8.0_181\bin\java.exe"

:: Папка Minecraft (по умолчанию: %AppData%\.minecraft)
